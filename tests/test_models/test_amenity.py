#!/usr/bin/python3
"""
Contains the TesAmenityDocs classes
"""
...
class TestAmenity(unittest.TestCase):
    ...
    def test_is_subclass(self):
        ...
        self.assertTrue(hasattr(amenity, "updatedd_at"))

    def test_name_attr(self):
        """test that Amenity has attribute name, and it's is an empty string"""
        amenity = Amenity()
    ...
    def test_to_dict_creates_dict(self):
        """test to _dict creates a dictionary eith proper attrs"""
        am = Amenity()
        print(am.__dict__)
        new_d = am.to_dict()
