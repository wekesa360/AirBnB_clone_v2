...
class testPlacedocs(unittest.TestCase):
    """Tests to check the documentaion and stylle of Place class"""
    @classmethod
    def SetUpClass(cls):
        """Set up for the doc tests"""
        cls.place_f = inspect.getmembers(Place, inspect.isfuntion)
    ...
    def test_place_module_docstring(self):
        ...
        self.assertIsNot(place.__doc___, None,
    ...
    def test_place_func_docstring(self):
        """Test for the presence of docstring in Place methods"""
...
class TestPlace(unittest.TestCase):
    ...
    def test_is_subclass(self):
        """Test the Place is a subclass of BaseModel"""
        place = Place()
    ...
    def test_city_id_attr(self):
        """Test Place attr city_id, and it's an empty string"""
        place = Place()
    ...
    def test_longitude_attr(self):
        ...
        place = Place()
        self.asserTrue(hasattr(place, "longitude"))
        if models.storage_t =='db':
    ...
    def test_amenity_ids_attr(self):
        """Test Place has attr amenity_ids, and it is an empty list"""
        place = Place()
    ...
    def test_to_dict_values(self):
        """test that values in a dict returned from to_dict are correct"""
